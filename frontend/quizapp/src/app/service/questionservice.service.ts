...
export class QuestionserviceService {
  ...
  constructor(private http:HttpClient) { }
   ...
   /* postResult(result:leaderBoard,id) : Observable<any>{
    ...
    createContest(contest): Observable<any>{
      ...
      let url='http://quizapp01.herokuapp.com/contests'
   ...
   //   return this.http.post('http://localhost:3000/quizapi/createContest',contest);
    ...
    getContestById(id):Observable<any>{
      ...
      //let url ='http://localhost:1337/contests/'+id;
      let url='http://quizapp01.herokuapp.com/contests/'+id;
      return this.http.get(url);
    }
    ...
    postExistingQuestions(id,questions:[question]):Observable<any>{
     ...
     getContestToEdit(id) : Observable<any>{
      ...
      searchByDomainKeyword(item: searchkey):Observable<any>{
         ...
         //let url="http://localhost:1337/questions/key"
         let url='http://quizapp01.herokuapp.com/questions/key'
      ...
      postResultFirstTime(result) : Observable<any>{
        ...
        let url='http://quizapp01.herokuapp.com/leaderboarditems'
      ...
      postTempResult(result,id) :Observable<any>{
        ...
        let url='http://quizapp01.herokuapp.com/leaderboarditems/'+id;
        return this.http.put(url,result);
      }
  ...
  //        let url = "http://localhost:3000/quizapi/createQuestionPaper";
        ...
        let url='http://quizapp01.herokuapp.com/questionpapers';
        return this.http.post(url,item);
      }
      ...
      getQuestionPaper(id):Observable<any>{
       ...
       let url='http://quizapp01.herokuapp.com/questionpapers/'+id;
        return this.http.get(url);
      }
      ...
      filterByLevel(item):Observable<any>{
        ...
        //let url = "http://localhost:1337/questions?level="+item;
        let url='http://quizapp01.herokuapp.com/questions?level='+item;
        return this.http.get(url);
        //return this.http.post(url,item);
      }
      ...
      //  let url = "http://localhost:1337/questions?type="+item;
      let url='http://quizapp01.herokuapp.com/questions?type='+item;
        //return this.http.post(url,item);
        return this.http.get(url);
      }

      filterByBothTypeandLevel(typeitem,levelitem):Observable<any>{
       // let url = "http://localhost:1337/questions?type="+typeitem+"&level="+levelitem;
       let url = "http://quizapp01.herokuapp.com/questions?type="+typeitem+"&level="+levelitem;
        return this.http.get(url);
      }
      ...
      addNewSection(item):Observable<any>{
        ...
        let url='http://quizapp01.herokuapp.com/sections';
        return this.http.post(url,item);
      }

      updateSection(item,id):Observable<any>{
        let url='http://quizapp01.herokuapp.com/sections/'+id;
        return this.http.put(url,item);
      }
